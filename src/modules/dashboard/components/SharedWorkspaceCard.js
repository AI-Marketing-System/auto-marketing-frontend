...
function SharedWorkspaceCard({ role, title, campaigns = [], avatarUrl, onSettingsClick, onCardClick }) {
    return (
        <div className="shared-card" onClick={onCardClick}>
            <div className="shared-card-header">
                <div className="shared-card-branding">
                    {avatarUrl ? (
                        <img src={avatarUrl} alt={title} className="shared-workspace-avatar" style={{ width: '32px', height: '32px', borderRadius: '8px', objectFit: 'cover' }} />
                    ) : (
