...
/**
 * Icon SVG viết tay theo phong cách Feather, khớp cách toàn bộ project đang làm
 * (không có package icon nào trong dependencies).
 */
...
export const FileTextIcon = ({ size = 20 }) => (
  <svg {...base(size)}>
...
export const CheckCircleIcon = ({ size = 18 }) => (
  <svg {...base(size)}>
...
export const AlertTriangleIcon = ({ size = 18 }) => (
  <svg {...base(size)}>
...
export const FolderIcon = ({ size = 18 }) => (
  <svg {...base(size)}>
...
export const ImageIcon = ({ size = 14 }) => (
  <svg {...base(size)}>
...
export const TargetIcon = ({ size = 14 }) => (
  <svg {...base(size)}>
    <circle cx="12" cy="12" r="10" />
