...
function DashboardPage() {
    ...
    const [sharedWorkspaces, setSharedWorkspaces] = useState([
        { id: 3, title: "FitLife Nutrition", role: "MEMBER", campaigns: ["FitLife Fanpage", "Summer Campaign 2026"] },
    ...
    const handleModalSubmit = (data) => {
        ...
        setWorkspaces([
            ...workspaces,
            { id: Date.now(), title: data.title, accountsCount: 0 }
        ]);
            ...
            <header className="dashboard-header-bar">
                ...
                <div className="header-right">
                    <button type="button" className="help-link-btn">
                        ...
                        <svg className="help-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <section className="workspace-section-container">
                        <div className="section-header">
                            ...
                            <div className="section-meta-info">
                                ...
                                <button type="button" className="icon-btn section-settings-btn" onClick={() => alert("Cài đặt tài khoản/tổ chức")}>
                    ...
                    <section className="shared-section-container">
                        <div className="section-header center-header">
                            <div className="section-title-wrapper justify-center">
                                ...
                                <span className="tooltip-icon" title="Các workspace được chia sẻ quyền quản trị/thành viên với bạn">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <circle cx="12" cy="12" r="10" />
                                        <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3M12 17h.01" />
                                    </svg>
