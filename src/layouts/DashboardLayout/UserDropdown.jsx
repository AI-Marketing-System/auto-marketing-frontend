...
export default function UserDropdown({ subscription, onUpgradeClick, onProfileClick, onSettingsClick }) {
        ...
        <div className="user-dropdown__menu">
          {activeTab === 'main' ? (
            <>
              ...
              <div
                className="user-dropdown__header-item"
              ...
              {/* Menu Items */}
              {subscription?.planName !== 'Admin' && (
                <button className="user-dropdown__item" onClick={() => { setOpen(false); onUpgradeClick(); }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                  <span>Nâng cấp gói</span>
                </button>
              )}

              <button className="user-dropdown__item" onClick={() => alert("Chức năng Cá nhân hóa đang phát triển.")}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9" /><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" /></svg>
                <span>Cá nhân hóa</span>
              </button>

              <button className="user-dropdown__item" onClick={() => { setOpen(false); onProfileClick(); }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>
                <span>Hồ sơ</span>
              </button>

              <button className="user-dropdown__item" onClick={() => { setOpen(false); onSettingsClick(); }}>
              ...
              <button className="user-dropdown__item" onClick={() => alert("Trợ giúp đang phát triển.")}>
            ...
            <>
              {/* Back Header */}
              <div
                className="user-dropdown__back-header"
              ...
              <button className="user-dropdown__item add-account-btn" onClick={() => alert("Chức năng Thêm tài khoản đang phát triển.")}>
