        ...
        <div className="user-dropdown__menu">
          {activeTab === 'main' ? (
            <>
              ...
              <button className="user-dropdown__item" onClick={() => alert("Chức năng Hồ sơ đang phát triển.")}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>
                <span>Hồ sơ</span>
              </button>

              <button className="user-dropdown__item" onClick={() => alert("Chức năng Cài đặt đang phát triển.")}>
            ...
            <>
              ...
              <div className="user-dropdown__sub-details-card">
